...
// let forget = require('./components/auth/ForgotPassword.vue').default;
...
let storereport = require('./components/report/create.vue').default;
let report = require('./components/report/report.vue').default;
let editreport = require('./components/report/edit.vue').default;
...
export const routes = [
 ...
 // Report Routes
{ path: '/store-report', component: storereport, name:'store-report'},
{ path: '/report', component: report, name:'report'},
{ path: '/edit-report/:id', component: editreport, name:'edit-report'},
