            ...
            <div class="col-xl-5 col-lg-5">
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  ...
                  <router-link to="/store-customer" class="btn btn-sm btn-info">Add Customer </router-link>
         <!-- <a class="btn btn-sm btn-info"><font color="#ffffff">Add Customer</font></a>  https://www.bkash.com/app/        -->
        ...
        <form @submit.prevent="orderdone">
         ...
         <option :value="customer.id" v-for="customer in customers">{{customer.name }} </option>
          ...
          <select class="form-control" v-model="payby">
                 ...
                 <option value="bkash">
                 <a link= "https://www.bkash.com/app/">Bkash</a> </option>
...
<script type="text/javascript">
 ...
 data(){
  ...
  orderdone(){
    ...
    var data = {qty:this.qty, subtotal:this.subtotal, customer_id:this.customer_id, payby:this.payby, 
    pay:this.pay, due:this.due, vat:this.vats.vat, total:total }
