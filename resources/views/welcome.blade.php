...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    || $route.path === '/Forgotpassword' || $route.path === '/ResetPasswordForm/:token'  ? false : true " style="display:  none;">
    <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        <div class="sidebar-brand-icon">  
               
            <img src="{{ asset('backend/img/logo/logo1.png')}}">        
        </div>
 ...
 <router-link class="collapse-item" to="/searchorder">Search</router-link>
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBootstrap10" aria-expanded="true"
        aria-controls="collapseBootstrap10">
        <i class="far fa-fw fa-window-maximize"></i>
        <span>Reports</span>
      </a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        id="topbar" v-show="$route.path === '/' || $route.path === '/register' || $route.path === '/Forgotpassword'
         || $route.path === '/ResetPasswordForm/:token' ? false : true " style="display: none;">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                <img class="img-profile rounded-circle" src="{{ asset('backend/img/girl.png')}}" style="max-width: 60px">              
        ...
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>copyright &copy; <script> document.write(new Date().getFullYear()); </script> - developed by
              <b><a href="https://github.com/sharmin123cse" target="_blank">sharmin</a></b>
            </span>
          </div>
        </div>
      </footer>
